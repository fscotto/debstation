...
declare -A fonts=(
  ["0xProto"]="https://github.com/ryanoasis/nerd-fonts/releases/download/v3.4.0/0xProto.zip"
  ["ComicShannsMono"]="https://github.com/ryanoasis/nerd-fonts/releases/download/v3.4.0/ComicShannsMono.zip"
